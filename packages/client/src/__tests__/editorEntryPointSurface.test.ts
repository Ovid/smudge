...
const EDITOR_HEADER_PROPS = [
  "projectTitle", "onNavigateHome", "editingProjectTitle", "projectTitleDraft",
  "setProjectTitleDraft", "saveProjectTitle", "cancelEditingProjectTitle",
  "startEditingProjectTitle", "projectTitleError", "projectTitleInputRef",
  "showActiveEditor", "viewMode", "toolbarEditor", "snapshotCount",
  "onToggleSnapshots", "onToggleFindReplace", "snapshotsTriggerRef",
  "findReplaceTriggerRef", "onSwitchToView", "onOpenExport",
  "onToggleReferencePanel", "panelOpen", "onOpenSettings",
];

const EDITOR_MAIN_CONTENT_PROPS = [
  "sidebarOpen", "sidebarWidth", "onSidebarResize", "project", "activeChapter",
  "showActiveEditor", "viewMode", "statuses", "onSelectChapter", "onAddChapter",
  "onDeleteChapter", "onReorderChapters", "onRenameChapter", "onOpenTrash",
  "onStatusChange", "editorLockedMessage", "actionError", "onDismissActionError",
  "actionInfo", "onDismissActionInfo", "trashOpen", "trashedChapters", "onRestore",
  "onCloseTrash", "dashboardRefreshKey", "viewingSnapshot", "onRestoreSnapshot",
  "onExitSnapshotView", "editingTitle", "titleDraft", "setTitleDraft", "saveTitle",
  "cancelEditingTitle", "startEditingTitle", "titleError", "titleInputRef",
  "chapterReloadKey", "editorRef", "onSave", "onContentChange", "onEditorReady",
  "onImageAnnouncement", "onImageUploadCommitted", "chapterWordCount", "saveStatus",
  "saveErrorMessage", "cacheWarning", "panelOpen", "panelWidth", "onPanelResize",
  "galleryExternalRefreshKey", "onInsertImage", "snapshotPanelOpen",
  "onCloseSnapshotPanel", "snapshotPanelRef", "onSnapshotView",
  "onSnapshotBeforeCreate", "onSnapshotsChange", "snapshotsTriggerRef",
  "findReplace", "onReplaceOne", "onReplaceAllInChapter",
  "onReplaceAllInManuscript", "findReplaceTriggerRef",
];

const EDITOR_DIALOGS_PROPS = [
  "deleteTarget", "onConfirmDelete", "onCancelDelete", "replaceConfirmation",
  "setReplaceConfirmation", "executeReplace", "navAnnouncement",
  "wordCountAnnouncement", "imageAnnouncement", "project", "projectSettingsOpen",
  "onCloseSettings", "onSettingsUpdate", "shortcutHelpOpen", "onCloseShortcutHelp",
  "exportDialogOpen", "onCloseExport",
];

const KEYBOARD_SHORTCUT_KEYS = [
  "shortcutHelpOpen", "deleteTarget", "projectSettingsOpen", "exportDialogOpen",
  "replaceConfirmOpen", "viewMode", "activeChapter", "project", "chapterWordCount",
  "flushSave", "setShortcutHelpOpen", "toggleSidebar", "handleCreateChapter",
  "handleSelectChapterWithFlush", "setWordCountAnnouncement", "setNavAnnouncement",
  "switchToView", "togglePanel", "toggleFindReplace",
];
...
describe("extractRegionNames (drift-detector self-tests)", () => {
  ...
  it("throws a readable error when the region markers are absent", () => {
    ...
    expect(() =>
      extractRegionNames("      <EditorMainContent\n        a={a}", MAIN_START, SELF_CLOSE, PROP_RE),
